...
public struct HTTPResponse: Sendable, Hashable {
    ...
    public struct Status: Sendable, Hashable, ExpressibleByIntegerLiteral, CustomStringConvertible {
        ...
        /* fileprivate but */ @inlinable init(uncheckedCode: Int, reasonPhrase: String) {
    ...
    /* private but */ @usableFromInline var reasonPhrase: String
...
extension HTTPResponse: Codable {
    ...
    /* private but */ @usableFromInline enum DecodingError: Error {
...
extension HTTPResponse.Status {
    ...
    @inlinable public static var `continue`: Self { .init(uncheckedCode: 100, reasonPhrase: "Continue") }
    ...
    @inlinable public static var earlyHints: Self { .init(uncheckedCode: 103, reasonPhrase: "Early Hints") }
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var ok: Self { .init(uncheckedCode: 200, reasonPhrase: "OK") }

    /// 201 Created
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var created: Self { .init(uncheckedCode: 201, reasonPhrase: "Created") }

    /// 202 Accepted
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var accepted: Self { .init(uncheckedCode: 202, reasonPhrase: "Accepted") }

    /// 203 Non-Authoritative Information
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var nonAuthoritativeInformation: Self {
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var noContent: Self { .init(uncheckedCode: 204, reasonPhrase: "No Content") }

    /// 205 Reset Content
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var resetContent: Self { .init(uncheckedCode: 205, reasonPhrase: "Reset Content") }

    /// 206 Partial Content
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var partialContent: Self { .init(uncheckedCode: 206, reasonPhrase: "Partial Content") }
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var multipleChoices: Self { .init(uncheckedCode: 300, reasonPhrase: "Multiple Choices") }

    /// 301 Moved Permanently
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var movedPermanently: Self { .init(uncheckedCode: 301, reasonPhrase: "Moved Permanently") }

    /// 302 Found
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var found: Self { .init(uncheckedCode: 302, reasonPhrase: "Found") }

    /// 303 See Other
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var seeOther: Self { .init(uncheckedCode: 303, reasonPhrase: "See Other") }

    /// 304 Not Modified
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var notModified: Self { .init(uncheckedCode: 304, reasonPhrase: "Not Modified") }

    /// 307 Temporary Redirect
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var temporaryRedirect: Self { .init(uncheckedCode: 307, reasonPhrase: "Temporary Redirect") }

    /// 308 Permanent Redirect
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var permanentRedirect: Self { .init(uncheckedCode: 308, reasonPhrase: "Permanent Redirect") }
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var badRequest: Self { .init(uncheckedCode: 400, reasonPhrase: "Bad Request") }

    /// 401 Unauthorized
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var unauthorized: Self { .init(uncheckedCode: 401, reasonPhrase: "Unauthorized") }

    /// 403 Forbidden
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var forbidden: Self { .init(uncheckedCode: 403, reasonPhrase: "Forbidden") }

    /// 404 Not Found
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var notFound: Self { .init(uncheckedCode: 404, reasonPhrase: "Not Found") }

    /// 405 Method Not Allowed
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var methodNotAllowed: Self { .init(uncheckedCode: 405, reasonPhrase: "Method Not Allowed") }

    /// 406 Not Acceptable
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var notAcceptable: Self { .init(uncheckedCode: 406, reasonPhrase: "Not Acceptable") }

    /// 407 Proxy Authentication Required
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var proxyAuthenticationRequired: Self {
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var requestTimeout: Self { .init(uncheckedCode: 408, reasonPhrase: "Request Timeout") }

    /// 409 Conflict
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var conflict: Self { .init(uncheckedCode: 409, reasonPhrase: "Conflict") }

    /// 410 Gone
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var gone: Self { .init(uncheckedCode: 410, reasonPhrase: "Gone") }

    /// 411 Length Required
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var lengthRequired: Self { .init(uncheckedCode: 411, reasonPhrase: "Length Required") }
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var contentTooLarge: Self { .init(uncheckedCode: 413, reasonPhrase: "Content Too Large") }

    /// 414 URI Too Long
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var uriTooLong: Self { .init(uncheckedCode: 414, reasonPhrase: "URI Too Long") }

    /// 415 Unsupported Media Type
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var unsupportedMediaType: Self { .init(uncheckedCode: 415, reasonPhrase: "Unsupported Media Type") }

    /// 416 Range Not Satisfiable
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var rangeNotSatisfiable: Self { .init(uncheckedCode: 416, reasonPhrase: "Range Not Satisfiable") }

    /// 417 Expectation Failed
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var expectationFailed: Self { .init(uncheckedCode: 417, reasonPhrase: "Expectation Failed") }

    /// 421 Misdirected Request
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var misdirectedRequest: Self { .init(uncheckedCode: 421, reasonPhrase: "Misdirected Request") }

    /// 422 Unprocessable Content
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var unprocessableContent: Self { .init(uncheckedCode: 422, reasonPhrase: "Unprocessable Content") }

    /// 425 Too Early
    @inlinable public static var tooEarly: Self { .init(uncheckedCode: 425, reasonPhrase: "Too Early") }

    /// 426 Upgrade Required
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var upgradeRequired: Self { .init(uncheckedCode: 426, reasonPhrase: "Upgrade Required") }

    /// 428 Precondition Required
    ///
    /// https://www.rfc-editor.org/rfc/rfc6585.html
    @inlinable public static var preconditionRequired: Self { .init(uncheckedCode: 428, reasonPhrase: "Precondition Required") }

    /// 429 Too Many Requests
    ///
    /// https://www.rfc-editor.org/rfc/rfc6585.html
    @inlinable public static var tooManyRequests: Self { .init(uncheckedCode: 429, reasonPhrase: "Too Many Requests") }

    /// 431 Request Header Fields Too Large
    ///
    /// https://www.rfc-editor.org/rfc/rfc6585.html
    @inlinable public static var requestHeaderFieldsTooLarge: Self {
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var internalServerError: Self { .init(uncheckedCode: 500, reasonPhrase: "Internal Server Error") }

    /// 501 Not Implemented
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var notImplemented: Self { .init(uncheckedCode: 501, reasonPhrase: "Not Implemented") }

    /// 502 Bad Gateway
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var badGateway: Self { .init(uncheckedCode: 502, reasonPhrase: "Bad Gateway") }

    /// 503 Service Unavailable
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var serviceUnavailable: Self { .init(uncheckedCode: 503, reasonPhrase: "Service Unavailable") }
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc9110.html
    @inlinable public static var httpVersionNotSupported: Self {
    ...
    ///
    /// https://www.rfc-editor.org/rfc/rfc6585.html
    @inlinable public static var networkAuthenticationRequired: Self {
